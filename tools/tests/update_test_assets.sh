...
python ../scripts/generate_binary_build_matrix.py --build-python-only disable > ../tests/assets/build_matrix_linux_wheel_cuda.json
python ../scripts/generate_binary_build_matrix.py --build-python-only disable --with-rocm disable > ../tests/assets/build_matrix_linux_wheel_cuda_norocm.json
python ../scripts/generate_binary_build_matrix.py --build-python-only disable --with-cpu disable > ../tests/assets/build_matrix_linux_wheel_nocpu.json
