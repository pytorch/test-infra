...
function selectRecordsById(data: any, workflowId: number) {
...
function Report({
  ...
  const selectedRecords = selectRecordsById(historicalData, latestWorkflowId);
  const latestDate = selectedRecords[0].granularity_bucket;

  return (
    <div>
      <BuildSummary branch={branch} sha={latestSha} date={latestDate} />
      <GraphPanel
        suite={suite}
        compiler={compiler}
        modelName={modelName}
