...
import { COMPILER_NAMES_TO_DISPLAY_NAMES, DTypePicker, DTYPES, BranchPicker, SuitePicker, SUITES } from "../../compilers";
  ...
  return (
    <Stack direction="row" spacing={2} sx={{ mb: 2 }}>
      <Typography fontSize={"1rem"} fontStyle={"italic"}>
        *This report was last generated by CI running on PyTorch {branch} branch at <a href={`${HUD_PREFIX}/${latestSha}`}>{latestSha.substring(0, 7)}</a>{" "}
    ...
    <div>
      <Stack direction="row" spacing={2} sx={{ mb: 2 }}>
        <Typography fontSize={"2rem"} fontWeight={"bold"}>
          TorchDynamo Performance DashBoard ({COMPILER_NAMES_TO_DISPLAY_NAMES[compiler] || compiler})
        </Typography>
        <TimeRangePicker
          startTime={startTime}
          stopTime={stopTime}
