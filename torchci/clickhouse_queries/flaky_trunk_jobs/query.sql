...
-- ever succeeded and never failed, red if it ever failed. Every red is classified as flake / real
-- / unknown (flake + real + unknown = red; green + red = total_runs). Flakes are split into
-- test_flake vs infra_flake by the log-classifier rule.
--
