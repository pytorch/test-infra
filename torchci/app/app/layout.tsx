...
import { AppBar, Toolbar, Typography, Link as MuiLink, CssBaseline, Container } from '@mui/material';
           ...
           <body>
             ...
             <AppBar position="fixed" sx={appBarStyles}>
               <Toolbar>
                 ...
                 <MuiLink component={Link} href="/" color="inherit" underline="none" sx={{ mr: 2 }}>
                   Home
                 </MuiLink>
                 <MuiLink component={Link} href="/app/benchmark/v3" color="inherit" underline="none" sx={{ mr: 2 }}>
                   Benchmarks
                 </MuiLink>
               </Toolbar>
             </AppBar>
