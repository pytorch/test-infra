...
os.environ["GITHUB_TOKEN"] = "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"
...
def main():
    ...
    if should_clear_alerts(sha_grid):
        print("HUD is all green. Clearing alerts.")
    ...
    if len(jobs_to_alert_on) > 0 and (no_alert_currently_active):
        print("Creating alerts", jobs_to_alert_on)
        issue = generate_failed_job_issue(jobs_to_alert_on)
        create_issue(issue)
