...
PACKAGES_PER_PROJECT: Dict[str, List[Dict[str, str]]] = {
    ...
    "dpcpp-cpp-rt": [{"project": "torch_xpu"}],
    "intel-cmplr-lib-rt": [{"project": "torch_xpu"}],
    "intel-cmplr-lib-ur": [{"project": "torch_xpu"}],
    "intel-cmplr-lic-rt": [{"project": "torch_xpu"}],
    "intel-opencl-rt": [{"project": "torch_xpu"}],
    "intel-sycl-rt": [{"project": "torch_xpu"}],
    "intel-openmp": [{"project": "torch_xpu"}],
    "tcmlib": [{"project": "torch_xpu"}],
    "umf": [{"project": "torch_xpu"}],
    "intel-pti": [{"project": "torch_xpu"}],
    "tbb": [{"project": "torch_xpu"}],
    "oneccl-devel": [{"project": "torch_xpu"}],
    "oneccl": [{"project": "torch_xpu"}],
    "impi-rt": [{"project": "torch_xpu"}],
    "onemkl-sycl-blas": [{"project": "torch_xpu"}],
    "onemkl-sycl-dft": [{"project": "torch_xpu"}],
