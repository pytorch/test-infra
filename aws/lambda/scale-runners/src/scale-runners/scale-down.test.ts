...
const RUNNERS_TO_BE_REMOVED_WITH_AUTO_SCALING_CONFIG = DEFAULT_RUNNERS.filter(
...
describe("scaleDown", () => {
  beforeEach(() => {
    ...
    process.env.MINIMUM_RUNNING_TIME_IN_MINUTES =
      minimumRunningTimeInMinutes.toString();
    jest.clearAllMocks();
