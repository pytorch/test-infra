...
def autorevert_checker(
    ...
    # Initialize checker
    checker = AutorevertPatternChecker(CHCliFactory().client, workflow_names=workflow_names, lookback_hours=hours)
    ...
    if len(workflow_names) == 1:
        ...
        if not commits:
            print(f"No commit data found for workflow '{workflow_names[0]}' in last {hours}h")
            return 1
