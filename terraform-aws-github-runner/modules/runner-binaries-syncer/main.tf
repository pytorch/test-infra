...
locals {
  action_runner_distribution_object_key_linux       = "actions-runner-linux-arm64-2.307.1.tar.gz"
  action_runner_distribution_object_key_linux_arm64 = "actions-runner-linux-x64.tar.gz"
